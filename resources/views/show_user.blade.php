...
<div class="flex justify-center items-center min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
    <div class="text-center bg-white p-12 rounded-[30px] shadow-2xl transform transition duration-500 hover:scale-105 hover:shadow-2xl w-full max-w-3xl">
        ...
        <div class="mt-8">
            <a href="{{ route('user.list') }}" class="px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-500 text-white text-lg font-bold rounded-full shadow-lg hover:from-purple-700 hover:to-pink-600 transition duration-300 transform hover:scale-110">
                Kembali ke Daftar
            </a>
        </div>
    </div>
